...
import com.game.base.enums.ClassCodeEnum;
...
public class ByteBufUtil {
    ...
    public static Map<Class,Integer> classCodeMap = new HashMap<>();
    ...
    public static ByteBuf objectToByteBuf(Object object) throws Exception {
        ...
        if (Optional.ofNullable(object).isPresent()) {//----begin
            ...
            int code = ClassCodeEnum.getCodeByBean(clz);
        ...
        try {
            if (buf.readableBytes() > 0) {//----begin
                ...
                if (!hadCode && Optional.ofNullable(object).isPresent()) {
                    ...
                    clz = ClassCodeEnum.getBeanByCode(code);
                    if (clz == null) {
                        return object;
                    }
...
//        Object clazz = createObject("com.wg.server.biz.entity.server.PlayData");
